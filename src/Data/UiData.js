...
export let SideBarDataForAdmin = [
  ...
  {
    name: "Regular Exam Result",
    url: "/admin/regular_exam_result",
    icon: "bi bi-file-earmark-text",
  },
  {
    name: "Transferred Course Result",
    url: "/admin/transferred_course_result",
    icon: "bi bi-file-earmark-text",
  },
  {
    name: "Supplementary Result",
  ...
  {
    name: "Admit Card Download",
    url: "/admin/admit_card_download",
    icon: "bi bi-file-earmark-pdf",
  },
  {
    name: "Online Payment",
    url: "/admin/online_payment",
    icon: "bi bi-cash-stack",
  },
  {
    name: "Due & Payment",
    url: "/admin/due_and_payment",
    icon: "bi bi-cash-stack",
  },
];
